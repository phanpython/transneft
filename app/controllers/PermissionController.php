...
class PermissionController extends AppController
{
    ...
    public function indexAction() {
        ...
        } elseif(isset($_POST['masking-permission'])) {
            /* echo print_r($_POST['masking-submit']); */
            /* $this->model->addStatusOfPermission($_POST['id'], 8); */
            /* $this->model->addMasking($_POST['']); */
        } elseif(isset($_POST['check_masking-permission'])) {
        ...
        } elseif(isset($_POST['unmasking-permission'])) {
            $this->model->addStatusOfPermission($_POST['id'], 11);
        } elseif(isset($_POST['check_unmasking-permission'])) {
