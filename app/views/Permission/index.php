		...
		<main class="content">
			<div class="content__body _container-main">
				...
				<div class="filter-content__funcs">
                    ...
                    <!-- Маскирование -->
                    {% if roles.isReplacementEngineer %}
                    <form action="" method="post" class="hidden" id="masking-permission">
                        <input type="submit" name="masking-permission" class="input button button-content permission-event button-permission masking-permission" value="Замаскировать">
                        <input type="text" class="row-id-process" hidden name="id" required id="">
                    </form>
                    {% endif %}
                    <!-- Проверка маскирования -->
                    {% if roles.isInspectingEngineer %}
                    <form action="" method="post" class="hidden" id="check_masking-permission">
                        <input type="submit" name="check_masking-permission" class="input button button-content permission-event button-permission" value="Проверить маскирование">
                        <input type="text" class="row-id-process" hidden name="id" required id="">
                    </form>
                    {% endif %}
                    {% if roles.isDispatcher %}
                    ...
                    <!-- Демаскирование -->
                    {% if roles.isReplacementEngineer %}
                    <form action="" method="post" class="hidden" id="unmasking-permission">
                        <input type="submit" name="unmasking-permission" class="input button button-content permission-event button-permission" value="Демаскировать">
                        <input type="text" class="row-id-process" hidden name="id" required id="">
                    </form>
                    {% endif %}
                    <!-- Проверка демаскирования -->
                    {% if roles.isInspectingEngineer %}
                    <form action="" method="post" class="hidden" id="check_unmasking-permission">
                        <input type="submit" name="check_unmasking-permission" class="input button button-content permission-event button-permission" value="Проверить демаскирование">
                        <input type="text" class="row-id-process" hidden name="id" required id="">
                    </form>
                    {% endif %}
                    {% if roles.isDispatcher %}
					...
					<div class="content__table table-content table-permission">
						...
						<div class="table-content__row table-row table-permission__row">
                            ...
                            <div class="table-content__col table-col table-permission__col-mask table-permission__masking-block">
                                ...
                                {% endif %}
                                {% endfor %}
                                    <input type="submit" name="masking-submit" hidden >
                                </form>                                 
							</div>
                            {% endif %}
                            <!--  -->
