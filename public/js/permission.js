...
if(document.getElementById('masking-submit')){
    let buttonMaskingPermission = document.querySelector('.masking-permission');
    console.log(buttonMaskingPermission);
    let formMasking = document.getElementById('masking-submit');
    console.log(formMasking);
